...
function (prob::ADNLPModelBuilder)(
    initial_guess;
    kwargs...
...
function get_build_exa_model(prob::AbstractCTOptimizationProblem)
    return throw(CTBase.NotImplemented("get_build_exa_model not implemented for $(typeof(prob))"))
end

function get_build_adnlp_model(prob::AbstractCTOptimizationProblem)
    return throw(CTBase.NotImplemented("get_build_adnlp_model not implemented for $(typeof(prob))"))
end
...
# ------------------------------------------------------------------------------
# ADNLPModels
struct ADNLPModelBackend{
    EmptyBackends<:Tuple{Vararg{Symbol}},
    KW
...
function (modeler::ADNLPModelBackend)(
    ...
    # build the model
    return get_build_adnlp_model(prob)(initial_guess; 
...
function (modeler::ExaModelBackend{BaseType, BackendType, KW})(
    ...
    return get_build_exa_model(prob)(BaseType, initial_guess; 
