# ============================================================================
# CTSolvers Strategies Module - REPL Style Display Demonstration (Simple)
# ============================================================================
...
println("🟢 julia> adnlp_modeler = CTSolvers.Modelers.ADNLPModeler(backend=:optimized, show_time=true)")
...
modeler_options = CTSolvers.Strategies.options(adnlp_modeler)
println("📋 Modeler options (compact):")
println(modeler_options)
println()

println("🟢 julia> display(CTSolvers.Strategies.options(adnlp_modeler))")
println("📋 Modeler options (pretty):")
display(modeler_options)
println()
...
println("  ", CTSolvers.Strategies.option_value(adnlp_modeler, :backend))
println()

println("🟢 julia> CTSolvers.Strategies.option_source(adnlp_modeler, :backend)")
println("📋 Individual option source:")
println("  ", CTSolvers.Strategies.option_source(adnlp_modeler, :backend))
println()

println("🟢 julia> CTSolvers.Strategies.is_user(adnlp_modeler, :backend)")
println("📋 Is user-set option:")
println("  ", CTSolvers.Strategies.is_user(adnlp_modeler, :backend))
println()

println("🟢 julia> CTSolvers.Strategies.is_default(adnlp_modeler, :show_time)")
println("📋 Is default option:")
println("  ", CTSolvers.Strategies.is_default(adnlp_modeler, :show_time))
println()
...
println("🟢 julia> opts = CTSolvers.Strategies.options(adnlp_modeler)")
opts = CTSolvers.Strategies.options(adnlp_modeler)
