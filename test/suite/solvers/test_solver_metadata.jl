...
function test_solver_metadata()
    Test.@testset "Solver Metadata and IDs" verbose=VERBOSE showtiming=SHOWTIMING begin
        ...
        Test.@testset "Parameterized Constructors" begin
            ...
            solver_cpu = Solvers.MadNLP{Strategies.CPU}(max_iter=100, print_level=MadNLP.ERROR)
            ...
            solver_ncl_cpu = Solvers.MadNCL{Strategies.CPU}(max_iter=100, print_level=MadNLP.ERROR)
