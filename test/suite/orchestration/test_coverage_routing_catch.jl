...
Strategies.metadata(::Type{FakeDisc}) = Strategies.StrategyMetadata(
    Options.OptionDefinition(name=:backend, type=Symbol, default=:cpu, description="Backend")
)

Strategies.metadata(::Type{FakeMod}) = Strategies.StrategyMetadata(
