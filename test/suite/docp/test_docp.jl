...
import CTSolvers.Modelers: AbstractNLPModeler
...
Subtypes AbstractNLPModeler to satisfy the type annotation on nlp_model/ocp_solution.
"""
struct FakeModelerDOCP <: AbstractNLPModeler
    backend::Symbol
end
