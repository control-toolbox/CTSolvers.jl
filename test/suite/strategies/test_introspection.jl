    ...
    Test.@testset "Strategy Introspection" verbose=VERBOSE showtiming=SHOWTIMING begin
        ...
        Test.@testset "Unit Tests" begin
            ...
            Test.@testset "option_type - type-level" begin
                Test.@test Strategies.option_type(IntrospectionTestStrategy, :max_iter) ===
                    Int
                Test.@test Strategies.option_type(IntrospectionTestStrategy, :tol) ===
                    Float64
                Test.@test Strategies.option_type(IntrospectionTestStrategy, :backend) ===
                    Symbol
            ...
            Test.@testset "option_default - type-level" begin
                Test.@test Strategies.option_default(
                    IntrospectionTestStrategy, :max_iter
                ) == 100
                Test.@test Strategies.option_default(IntrospectionTestStrategy, :tol) ==
                    1e-6
                Test.@test Strategies.option_default(IntrospectionTestStrategy, :backend) ==
                    :cpu
        ...
        Test.@testset "Integration Tests" begin
            Test.@testset "Type-level vs instance-level consistency" begin
                ...
                Test.@test Strategies.option_value(strategy, :max_iter) !=
                    type_defaults.max_iter
                Test.@test Strategies.option_value(strategy, :tol) != type_defaults.tol
                Test.@test Strategies.option_value(strategy, :backend) !=
                    type_defaults.backend
            end
